  ...
  return (
    <div className="slider-container relative overflow-hidden mr-0 ml-auto w-full">
      <div className="slides flex gap-2">
        <button className="bg-black px-1 py-1.5 rounded-md text-sm font-semibold text-white min-w-[90px]">
          All
        </button>
        {categories.map((category) => (
          <button
            ...
            className="bg-gray-100 hover:bg-gray-200 p-1.5 rounded-md text-sm font-medium min-w-[90px] text-nowrap"
          >
            {category}
          </button>
        ))}
